...
/* @Configuration 이라고 하면 JPA가 '이건 설정파일' 이라고 인식해서 Configration Bean으로 등록함 */
@Configuration
...
public class Ex01_3_JpaConfig {
    ...
    public AuditorAware<String> auditorAware() {
        ...
        // 이렇게 하면 앞으로 JPA Auditing 할때마다 사람 이름은 bitstudy 로 넣게 됨
        // TODO: 나중에 스프링 시큐리티로 인증 기능 붙일 때 수정할거임
    }
}
