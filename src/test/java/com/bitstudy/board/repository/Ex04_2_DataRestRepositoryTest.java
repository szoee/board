...
public class Ex04_2_DataRestRepositoryTest {
    ...
    @DisplayName("[api] 댓글 리스트 전체 조회") // ArticleComment에 있는 모든 댓글이 아니라 특정 Article의 댓글들 전체 조회인거임
    @Test
    ...
    @DisplayName("[api] 댓글 단일 조회") // ArticleComment에 있는 모든 댓글이 아니라 특정 Article의 댓글들 전체 조회인거임
    @Test
